package com.example.commonlibrary.customview.draglayout;
    ...
    private class DragViewCallBack extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (dragState == DRAG_STATE_OPEN) {
                ...
                content.setScaleX((1 - percent * 0.20f));
                content.setScaleY(1 - percent * 0.20f);
                menu.setScaleY(0.8f + percent * 0.20f);
                menu.setScaleY(0.8f + percent * 0.20f);
                if (mListener != null) {
